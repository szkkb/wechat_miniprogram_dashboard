...
export const WEBFX_CATALOG = [
  ...
  { id: 'freight-forwarding', name: { en: 'Freight Forwarding', zh: '货代操作面板' }, group: 'industry', sub: 'logistics', route: '/web-fx/industry-styles', hash: 'freight-forwarding' },
  { id: 'warehouse-wms', name: { en: 'Warehouse WMS', zh: '仓储管理系统' }, group: 'industry', sub: 'logistics', route: '/web-fx/industry-styles', hash: 'warehouse-wms' },
  { id: 'container-tracking', name: { en: 'Container Tracking', zh: '集装箱追踪' }, group: 'industry', sub: 'logistics', route: '/web-fx/industry-styles', hash: 'container-tracking' },
